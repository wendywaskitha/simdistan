...
<body>
<h2>LAPORAN PENYULUHAN — DATA KELOMPOK TANI</h2>
<p class="subtitle">Kabupaten Muna Barat | Dicetak: {{ date('d/m/Y H:i') }}</p>
<table>
    <thead><tr><th>No</th><th>Nama Kelompok Tani</th><th>Ketua</th><th>Desa</th><th>Kecamatan</th><th>Gapoktan</th><th>Jml Petani</th></tr></thead>
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">{{ $k->petanis_count }}</td>
        </tr>
        @endforeach
        <tr class="total-row"><td colspan="7">Total: {{ $kelompokTanis->count() }} kelompok tani</td></tr>
    </tbody>
</table>
