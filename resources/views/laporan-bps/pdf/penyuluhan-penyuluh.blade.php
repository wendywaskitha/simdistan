...
<body>
<h2>LAPORAN PENYULUHAN — DATA PENYULUH</h2>
<p class="subtitle">Kabupaten Muna Barat | Dicetak: {{ date('d/m/Y H:i') }}</p>
<table>
    <thead><tr><th>No</th><th>Nama Penyuluh</th><th>NIP</th><th>Telepon</th><th>BPP</th><th>Kecamatan</th></tr></thead>
    <tbody>
        ...
        @endforeach
        <tr class="total-row"><td colspan="6">Total: {{ $penyuluhs->count() }} penyuluh</td></tr>
    </tbody>
</table>
