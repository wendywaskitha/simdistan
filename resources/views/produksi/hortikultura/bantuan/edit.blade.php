...
@section('title', 'Edit Bantuan Bibit Hortikultura')
...
<x-breadcrumb :items="[
    ['label' => 'Hortikultura', 'url' => route('hortikultura.index')],
    ['label' => 'Bantuan Bibit', 'url' => route('bantuan-bibit-horti.index')],
    ['label' => 'Edit Bantuan']
]" />

<form action="{{ route('bantuan-bibit-horti.update', $bantuan->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6">
            <div class="card custom-card border-0 p-4 mb-4">
                <h5 class="fw-bold mb-4">Form Edit Bantuan Bibit</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <x-form.input 
                            name="satuan" 
                            label="Satuan" 
                            placeholder="Contoh: Pohon, Polybag, Kg" 
                            required="true" 
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('bantuan-bibit-horti.index') }}" class="btn btn-light rounded-3 px-4">Batal</a>
