...
@section('title', 'Kelola Bantuan Bibit Hortikultura')
...
<div class="card custom-card border-0 p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h5 class="fw-bold mb-1">Daftar Bantuan Bibit Hortikultura</h5>
            <p class="text-muted small mb-0">Kelola riwayat bantuan bibit komoditas sayuran & buah kepada Kelompok Tani.</p>
        </div>
        <a href="{{ route('bantuan-bibit-horti.create') }}" class="btn btn-success rounded-3 px-4 py-2">
    ...
    <x-table :headers="['No', 'Kelompok Tani', 'Komoditas', 'Jumlah Bantuan', 'Sumber Dana', 'Tahun', 'Keterangan', 'Aksi']" id="bantuanTable" />
</div>
@endsection
...
<script>
    $(document).ready(function() {
        $('#bantuanTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('bantuan-bibit-horti.index') }}",
            columns: [
