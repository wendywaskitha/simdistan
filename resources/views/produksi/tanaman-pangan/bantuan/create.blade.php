...
@section('title', 'Tambah Bantuan Benih Tanaman Pangan')
...
<form action="{{ route('bantuan-benih-pangan.store') }}" method="POST">
    @csrf
    <div class="row">
        <div class="col-md-6">
            <div class="card custom-card border-0 p-4 mb-4">
                <h5 class="fw-bold mb-4">Form Tambah Bantuan Benih</h5>
