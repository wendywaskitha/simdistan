...
@section('title', 'Kelola Bantuan Bibit Perkebunan')
...
<div class="card custom-card border-0 p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h5 class="fw-bold mb-1">Daftar Bantuan Bibit Perkebunan</h5>
            <p class="text-muted small mb-0">Kelola riwayat bantuan bibit kelapa, cengkeh, dll., kepada Kelompok Tani.</p>
        </div>
        <a href="{{ route('bantuan-bibit-perkebunan.create') }}" class="btn btn-success rounded-3 px-4 py-2">
...
<script>
    $(document).ready(function() {
        $('#bantuanTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('bantuan-bibit-perkebunan.index') }}",
            columns: [
